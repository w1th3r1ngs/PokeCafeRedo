...
export const createMenuItems = (categoryIds: { bowls: string, wraps: string, appetizers: string, desserts: string, drinks: string }): InsertMenuItem[] => [
  ...
  // Drinks - Smoothies
  {
    ...
    price: "5.50",
    image: "/images/drinks/smoothie-green.jpg",
  ...
  },
  {
    ...
    price: "5.50",
    image: "/images/drinks/smoothie-golden.jpg",
    categoryId: categoryIds.drinks,
    available: 1,
    popular: 0,
  },
  {
    ...
    price: "5.50",
    image: "/images/drinks/smoothie-vitamin.jpg",
    categoryId: categoryIds.drinks,
    available: 1,
    popular: 0,
  },
  {
    ...
    price: "5.50",
    image: "/images/drinks/smoothie-purple.jpg",
    categoryId: categoryIds.drinks,
    available: 1,
    popular: 0,
  },
